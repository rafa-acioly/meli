            ...
            <div class="w-full overflow-x-scroll xl:overflow-x-hidden">
                <table class="min-w-full bg-white dark:bg-gray-800">
                    ...
                    @forelse($categories as $category)
                        <tr wire:loading.class="opacity-75" class="h-24 border-gray-300 border-b">
                            ...
                            <td class="pr-8 relative">
                                <button class="text-gray-500 rounded cursor-pointer border border-transparent focus:outline-none" wire:click="$emit('editCategory', {{ $category }})">
                                    <svg
